    ...
    <div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
      <div class="mb-7">
        ...
        <p class="text-gray-400">
          ...
          <a href="/auth/signin" class="text-sm text-purple-700 hover:text-purple-700">Sign In</a>
        </p>
      </div>
      <div class="space-y-6">
        <div class="">
        ...
        <div class="mt-7 text-center text-gray-300 text-xs">
          <span>
            Copyright © 2022
            <a href="https://ids.company" rel="" target="_blank" title="Codepen aji" class="text-purple-500 hover:text-purple-600 ">ids.company</a>
          </span>
        </div>
      </div>
    </div>
